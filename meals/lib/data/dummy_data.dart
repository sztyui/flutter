...
List<Category> availableCategories = [
  ...
  Category(id: 'c11', title: 'Cigány', color: Colors.brown),
];
...
const dummyMeals = [
  ...
  Meal(
    id: 'm11',
    categories: ['c11'],
    title: 'Cigánypecsenye',
    affordability: Affordability.luxurious,
    complexity: Complexity.challenging,
    imageUrl:
        'https://upload.wikimedia.org/wikipedia/commons/0/0c/Gabor_ciganyok..jpg',
    duration: 30,
    ingredients: [
      '4 szelet tarja (kb. 400 g)',
      'só, bors', 
      '3 ek liszt',
      '1 mk fűszerpaprika',
      '2 ek étolaj',
